...
df = transform_data(photo_apprentissage_path+"/photos-bouygues/", photo_apprentissage_path+'/apprentissage-bouygues-only-originals/','', new_size=[250,250,3])
df.to_csv(photo_apprentissage_path+'/output_bouygues-only-originals.csv')
